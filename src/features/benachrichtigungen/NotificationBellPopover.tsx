    ...
    <Popover>
      ...
      <PopoverContent align="end" className="w-[360px] p-0 shadow-lg">
        <div className="flex items-center justify-between border-b border-border p-3">
          <h3 className="text-sm font-semibold text-charcoal">Benachrichtigungen</h3>
          {unreadCount > 0 && (
            <Button
              variant="ghost"
              size="sm"
            ...
            >
              <Check className="mr-1 size-3" /> Alle gelesen
            </Button>
          )}
        </div>
        ...
        <div className="max-h-[340px] overflow-y-auto divide-y divide-border">
          {notifications.length === 0 ? (
            <div className="p-6 text-center text-sm text-slate">Keine Benachrichtigungen.</div>
          ) : (
