      ...
      <DialogContent className="max-w-[480px]">
        ...
        <div className="space-y-5">
          <div className="space-y-1.5">
            <Label htmlFor="edit-asset-name">{t("edit.name")}</Label>
            <Input
              id="edit-asset-name"
              value={name}
              maxLength={60}
          ...
          {asset.kind === "account" && (
            <div className="space-y-1.5">
              <Label htmlFor="edit-asset-iban">{t("create.ibanOptional")}</Label>
              <Input
                id="edit-asset-iban"
                value={iban}
          ...
          <div className="space-y-1.5">
            <Label htmlFor="edit-asset-type">{t("create.type")}</Label>
            {asset.kind === "account" ? (
          ...
          {showSparzweck && (
            <div className="space-y-1.5">
              <Label htmlFor="edit-asset-sparzweck">{t("edit.defaultSavingsGoal")}</Label>
              <Select
              ...
              >
                ...
                <SelectContent>
                  <SelectItem value="none">{t("edit.noSavingsGoal")}</SelectItem>
                  {sparzwecke?.map((s) => (
